...
import utils.sentinel.bands.Sentinel1Bands;
...
public class SentinelBands {
    private static Map<WorkflowType, Sentinel1Bands> getMap() {
        Map<WorkflowType, utils.sentinel.bands.Sentinel1Bands> map = new HashMap<>();
        map.put(WorkflowType.GRD,new GRDSentinel1Bands());
        map.put(WorkflowType.SLC,new SLCSentinel1Bands());
        return map;
    }

    public static List<String> getBands(ProductDTO sentinel1, WorkflowDTO workflowDTO) {
