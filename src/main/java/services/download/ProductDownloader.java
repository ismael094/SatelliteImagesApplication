...
public class ProductDownloader implements Downloader, Runnable {

    static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(ProductDownloader.class.getName());
    ...
    public ProductDownloader(int maxFilesDownloading) {
